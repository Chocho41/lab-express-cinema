...
//we are requiring mongoose config

const movieModel = require('./../models/Movie.model');
// we are requiring the models
...
const movies = [
  ...
  // ... your code here
  movieModel.insertMany(movies) //it is a Promises (async)
  .then((dbSuccess) => {
      console.log("SUCCESS !!! the DB is in MongoDB COMPASS, you rock mate");
